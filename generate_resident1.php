...
<head>
	...
	<title>Generate Resident Profile -  Barangay Health Reposirotry  System</title>
</head>
<body>
				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white fw-bold">Generate Resident Nutrition Profile</h2>
							</div>
						</div>
					</div>
				</div>
                            ...
                            <div class="card">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title">Resident Nutrition Profile</div>
								...
								<div class="card-body m-5" id="printThis">
                                    <div class="d-flex flex-wrap justify-content-center" style="border-bottom:1px solid red">
										<div class="text-center">
                                            ...
                                            <h3 class="mb-0">Province of Ilocos Norte</h3>
											<h3 class="mb-0">Municipality of Bacarra</h3>
											<h1 class="fw-bold mb-0">Brgy 20 Pulangi</i></h1>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-group row">
                                                <h3 class="mt-5 col-lg-4 col-md-4 col-sm-4 mt-sm-2 text-left">Nutrition Status:</h3>
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-sm-12 text-left">
