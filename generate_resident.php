...
<head>
	...
	<title>Generate Resident Profile -  Barangay Health Repository System</title>
</head>
<body>
				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white fw-bold">Generate Resident Vaccination Profile</h2>
							</div>
						</div>
					</div>
				</div>
                            ...
                            <div class="card">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title">Resident Vaccination Profile</div>
								...
								<div class="card-body m-5" id="printThis">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-group row">
                                                <h3 class="mt-5 col-lg-4 col-md-4 col-sm-4 mt-sm-2 text-left">Vaccination Status:</h3>
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-sm-12 text-left">
